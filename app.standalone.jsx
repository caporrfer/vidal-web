    ...
    <div className="app">
      ...
      <section className="hero">
        ...
        <div className="hero-visual">
          <img src={window.__resources.shop} alt="Estudio Vidal Barber" />
      ...
      <section id="gallery" className="block">
        ...
        <div className="gallery">
          <div className="g-item g-1"><img src={window.__resources.cut1} alt=""/><span className="tag">001 — Platinum Fade</span></div>
          <div className="g-item g-2"><img src={window.__resources.shop} alt=""/><span className="tag">002 — El estudio</span></div>
          <div className="g-item g-3"><img src={window.__resources.cut2} alt=""/><span className="tag">003 — Fringe texture</span></div>
          <div className="g-item g-4"><img src={window.__resources.cut3} alt=""/><span className="tag">004 — Barba clásica</span></div>
          <div className="g-item g-5"><img src={window.__resources.cut1} alt=""/><span className="tag">005 — Skin fade</span></div>
        </div>
      </section>
